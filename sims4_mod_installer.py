...
# -*- coding: utf-8 -*-
"""
Sims 4 Auto Mod Installer v2.1.0
...
class Sims4ModInstaller:
    def __init__(self):
        ...
        self.root.title("Sims 4 Auto Mod Installer v2.1.0")
    ...
    def auto_install_update(self, window, download_url):
        ...
        try:
            ...
            update_file = os.path.join(self.download_folder, "update.exe")
...
'''
    ...
    def create_gui(self):
        ...
        # Заголовок
        title_label = ttk.Label(main_frame, text="Sims 4 Auto Mod Installer v2.1.0", font=("Arial", 16, "bold"))
